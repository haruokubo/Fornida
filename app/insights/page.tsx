    ...
    <main className="min-h-screen bg-zinc-950 text-white">
      ...
      <nav className="sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-700 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/insights" className="text-sm text-white font-semibold border-b border-zinc-900 pb-0.5">Insights</a>
      ...
      <div className="border-b border-zinc-800 bg-zinc-900">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <p className="text-white text-xs font-bold uppercase tracking-widest mb-3">Insights</p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        {/* FEATURED VIDEO */}
        <div className="mb-16">
          <p className="text-white text-xs font-bold uppercase tracking-widest mb-6">Featured Video</p>

          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            {/* Video embed */}
            <div className="lg:col-span-3">
              <div className="relative w-full rounded-2xl overflow-hidden border border-zinc-800 bg-zinc-900" style={{ paddingTop: "56.25%" }}>
                <iframe
            ...
            <div className="lg:col-span-2 flex flex-col justify-center">
              <span className="inline-block text-xs font-bold text-white bg-zinc-950 border border-zinc-700 px-3 py-1 rounded-full mb-4">
                {FEATURED_VIDEO.category}
              </span>
              <h2 className="text-2xl font-black tracking-tight mb-4 leading-snug text-white">
        ...
        {/* ARTICLE GRID */}
        <div>
          <p className="text-white text-xs font-bold uppercase tracking-widest mb-8">Latest Articles</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {INSIGHTS.map((item) => (
              <article
                key={item.title}
                className="group bg-zinc-900 border border-zinc-800 shadow-sm rounded-2xl p-7 hover:border-zinc-600 hover:-translate-y-1 transition-all duration-300 flex flex-col cursor-pointer"
              >
                <div className="flex items-center justify-between mb-5">
                  <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full border ${TAG_COLORS[item.tag] ?? "text-zinc-400 bg-zinc-950 border-zinc-800"}`}>
                    {item.tag}
                  </span>
                  <span className="text-[10px] text-zinc-500">{item.readTime}</span>
                </div>
                <h3 className="text-base font-bold leading-snug mb-3 text-white group-hover:text-white transition-colors flex-1">
                  {item.title}
                </h3>
                <p className="text-zinc-500 text-sm leading-relaxed mb-5">
                  {item.desc}
                </p>
                <span className="text-white text-xs font-semibold transition-colors">
                  Read article →
                </span>
              </article>
            ))}
        ...
        {/* NEWSLETTER CTA */}
        <div className="mt-20 bg-zinc-900 border border-zinc-800 rounded-2xl p-10 text-center">
          <p className="text-white text-xs font-bold uppercase tracking-widest mb-3">Stay Sharp</p>
          <h2 className="text-3xl font-black tracking-tight mb-3 text-white">Get insights in your inbox</h2>
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <input
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-xl px-5 py-3 text-sm text-white placeholder-zinc-400 focus:outline-none focus:border-stone-400 transition-all w-72"
            />
            <button className="bg-white text-zinc-950 font-bold text-sm px-6 py-3 rounded-xl hover:bg-zinc-900 transition-all">
              Subscribe →
            </button>
          </div>
        </div>
