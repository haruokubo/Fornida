  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-3">
              <div className="relative w-full rounded-2xl overflow-hidden border border-stone-200 bg-stone-50" style={{ paddingTop: "56.25%" }}>
                <iframe
            ...
            <div className="lg:col-span-2 flex flex-col justify-center">
              <span className="inline-block text-xs font-bold text-zinc-900 bg-stone-100 border border-stone-300 px-3 py-1 rounded-full mb-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {INSIGHTS.map((item) => (
              <article
                key={item.title}
                className="group bg-white border border-stone-200 shadow-sm rounded-2xl p-7 hover:border-stone-300/50 hover:-translate-y-1 transition-all duration-300 flex flex-col cursor-pointer"
              >
                <div className="flex items-center justify-between mb-5">
                  <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full border ${TAG_COLORS[item.tag] ?? "text-stone-600 bg-stone-100 border-stone-200"}`}>
                    {item.tag}
                  </span>
        ...
        {/* NEWSLETTER CTA */}
        <div className="mt-20 bg-white border border-stone-200 rounded-2xl p-10 text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            <input
              ...
              className="bg-stone-50 border border-stone-200 rounded-xl px-5 py-3 text-sm text-zinc-900 placeholder-zinc-400 focus:outline-none focus:border-stone-400 transition-all w-72"
            />
            <button className="bg-zinc-900 text-white font-bold text-sm px-6 py-3 rounded-xl hover:bg-zinc-900 transition-all">
              Subscribe →
            </button>
          </div>
        </div>
